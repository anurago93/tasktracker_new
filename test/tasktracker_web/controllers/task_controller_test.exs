defmodule TasktrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{createdBy: "some createdBy", description: "some description", time: 42, title: "some title"}
  @update_attrs %{createdBy: "some updated createdBy", description: "some updated description", time: 43, title: "some updated title"}
  @invalid_attrs %{createdBy: nil, description: nil, time: nil, title: nil}
  ...
  describe "update task" do
    ...
    test "redirects when data is valid", %{conn: conn, task: task} do
      ...
      assert html_response(conn, 200) =~ "some updated createdBy"
    end
